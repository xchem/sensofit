"""Tests for creoptix_fitting.ode_pure_grid — pure ODE with grid seeds."""
...
from creoptix_fitting.ode_pure_grid import fit_sample
...
class TestFitSample:
    ...
    def test_27_starts(self, first_result):
        assert first_result['n_starts'] == 27
